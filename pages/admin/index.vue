    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          ...
          <!-- Navigation Container - spans to the right edge -->
          <div class="flex items-center justify-between flex-1 ml-8">
            <!-- Group 1: Left side - Utility actions -->
            ...
            <!-- Group 2: Right side - Main navigation -->
            <div class="flex items-center gap-2">
              <button
                @click="refreshData"
                :disabled="loading"
              ...
              <NuxtLink to="/admin/messages" class="relative group btn-secondary flex items-center justify-center w-10 h-10 p-0">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
